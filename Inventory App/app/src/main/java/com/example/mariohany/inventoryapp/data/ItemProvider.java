...
import static com.example.mariohany.inventoryapp.data.ItemContract.CONTENT_AUTHORITY;
...
import static com.example.mariohany.inventoryapp.data.ItemContract.ItemEntry.CONTENT_ITEM_TYPE;
import static com.example.mariohany.inventoryapp.data.ItemContract.ItemEntry.CONTENT_LIST_TYPE;
...
import static com.example.mariohany.inventoryapp.data.ItemContract.PATH_ITEMS;

/**
 * Created by Mario Hany on 2017-08-12.
 */
...
public class ItemProvider extends ContentProvider {
    ...
    private Uri insertProduct(Uri uri, ContentValues values) {
        ...
        Long quantity = values.getAsLong(COLUMN_ITEM_QUANTITY);
        if (quantity != null && quantity < 0) {
            throw new IllegalArgumentException("Product requires valid quantity");
        }

        Float price = values.getAsFloat(COLUMN_ITEM_PRICE);
